...
export const mountains: Mountain[] = [
  ...
  { id: "003", name: "七星山", height: 1120, type: "小百岳", lat: 25.170, lng: 121.545 },
  ...
  { id: "011", name: "李崠山", height: 1914, type: "小百岳", lat: 24.646, lng: 121.300 },
  { id: "012", name: "巴博庫魯山", height: 2101, type: "中級山", lat: 24.673, lng: 121.470 },
  ...
  { id: "017", name: "鹿場大山", height: 2360, type: "中級山", lat: 24.498, lng: 121.050 },
  ...
  { id: "021", name: "桃山", height: 3325, type: "百岳", lat: 24.417, lng: 121.300 },
  { id: "022", name: "品田山", height: 3529, type: "百岳", lat: 24.428, lng: 121.267 },
  { id: "023", name: "穆特勒布山", height: 3626, type: "高山", lat: 24.417, lng: 121.250 },
  { id: "024", name: "雪山", height: 3886, type: "百岳", lat: 24.383, lng: 121.233 },
  { id: "025", name: "火炎山", height: 602, type: "小百岳", lat: 24.363, lng: 120.730 },
  ...
  { id: "029", name: "中央尖山", height: 3705, type: "百岳", lat: 24.317, lng: 121.400 },
  ...
  { id: "039", name: "能高南峰", height: 3349, type: "百岳", lat: 24.000, lng: 121.283 },
  { id: "040", name: "九份二山", height: 1174, type: "小百岳", lat: 23.950, lng: 120.833 },
  { id: "041", name: "干卓萬山", height: 3284, type: "百岳", lat: 23.900, lng: 121.133 },
  { id: "042", name: "安東軍山", height: 3068, type: "百岳", lat: 23.867, lng: 121.267 },
  { id: "043", name: "集集大山", height: 1392, type: "小百岳", lat: 23.850, lng: 120.817 },
  { id: "044", name: "水社大山", height: 2059, type: "中級山", lat: 23.842, lng: 120.950 },
  { id: "045", name: "治茆山", height: 2909, type: "中級山", lat: 23.800, lng: 120.983 },
  { id: "046", name: "鳳凰山", height: 1698, type: "小百岳", lat: 23.700, lng: 120.817 },
  { id: "047", name: "東郡大山", height: 3619, type: "百岳", lat: 23.683, lng: 121.050 },
  ...
  { id: "051", name: "郡大山", height: 3265, type: "百岳", lat: 23.583, lng: 120.950 },
  { id: "052", name: "大塔山", height: 2663, type: "小百岳", lat: 23.533, lng: 120.800 },
  { id: "053", name: "馬利加南山", height: 3546, type: "百岳", lat: 23.517, lng: 121.117 },
  { id: "054", name: "馬博拉斯山", height: 3785, type: "百岳", lat: 23.517, lng: 121.067 },
  { id: "055", name: "秀姑巒山", height: 3805, type: "百岳", lat: 23.500, lng: 121.050 },
  { id: "056", name: "玉山北峰", height: 3858, type: "百岳", lat: 23.485, lng: 120.953 },
  { id: "057", name: "大水窟山", height: 3642, type: "百岳", lat: 23.467, lng: 121.050 },
  { id: "058", name: "玉山", height: 3952, type: "百岳", lat: 23.470, lng: 120.957 },
  { id: "059", name: "玉穗山", height: 1578, type: "中級山", lat: 23.233, lng: 120.817 },
  { id: "060", name: "大凍山", height: 1241, type: "小百岳", lat: 23.317, lng: 120.500 },
  ...
  { id: "066", name: "大母母山", height: 2424, type: "中級山", lat: 22.750, lng: 120.750 },
  ...
  { id: "070", name: "壽山", height: 356, type: "小百岳", lat: 22.650, lng: 120.267 },
  { id: "071", name: "北大武山", height: 3092, type: "百岳", lat: 22.628, lng: 120.760 },
  { id: "072", name: "南大武山", height: 2841, type: "中級山", lat: 22.567, lng: 120.750 },
  { id: "073", name: "里龍山", height: 1062, type: "小百岳", lat: 22.183, lng: 120.717 },
  { id: "074", name: "烘爐地山", height: 1166, type: "中級山", lat: 24.850, lng: 121.733 },
  { id: "075", name: "三星山", height: 2352, type: "小百岳", lat: 24.517, lng: 121.567 },
  { id: "076", name: "飯包山", height: 1857, type: "中級山", lat: 24.500, lng: 121.683 },
  { id: "077", name: "清水大山", height: 2408, type: "中級山", lat: 24.233, lng: 121.617 },
  { id: "078", name: "三角錐山", height: 2607, type: "中級山", lat: 24.200, lng: 121.567 },
  { id: "079", name: "塔山", height: 2449, type: "中級山", lat: 24.150, lng: 121.533 },
  ...
  { id: "084", name: "木瓜山", height: 2427, type: "中級山", lat: 23.900, lng: 121.467 },
  { id: "085", name: "針山", height: 2340, type: "中級山", lat: 23.867, lng: 121.367 },
  { id: "086", name: "南二子山", height: 2454, type: "中級山", lat: 23.833, lng: 121.417 },
  { id: "087", name: "王武塔山", height: 2022, type: "中級山", lat: 23.750, lng: 121.383 },
  { id: "088", name: "阿屘那來山", height: 3061, type: "高山", lat: 23.717, lng: 121.300 },
  ...
  { id: "093", name: "成廣澳山", height: 1598, type: "中級山", lat: 23.167, lng: 121.350 },
  { id: "094", name: "新港山", height: 1682, type: "中級山", lat: 23.133, lng: 121.317 },
  { id: "095", name: "美奈田主山", height: 2931, type: "中級山", lat: 22.950, lng: 120.933 },
  ...
  { id: "099", name: "紅頭山", height: 552, type: "小百岳", lat: 22.050, lng: 121.550 },
  { id: "100", name: "太武山", height: 253, type: "小百岳", lat: 24.461, lng: 118.426 },
];

export function getTypeColor(type: Mountain["type"]): string {
  switch (type) {
    case "百岳":
